package com.example.notecompus.datepicker;
...
//        Log.e("getInstance ",simpleDateFormat.format(mBeginTime.getTime()));


        mBeginTime.setTimeInMillis(beginTimestamp);
//        Log.e("setTimeInMillis ",simpleDateFormat.format(mBeginTime.getTime()));
        mEndTime = Calendar.getInstance();
        mEndTime.setTimeInMillis(endTimestamp+endTimestamp);
...
//        mPickerDialog = new Dialog(mContext, R.style.date_picker_dialog);
        mPickerDialog = new Dialog(mContext);
